...
public class ObjectFactory {
    ...
    private final static QName _Download_QNAME = new QName("http://server.binary.ws.codejava.net/", "download");
    private final static QName _DownloadResponse_QNAME = new QName("http://server.binary.ws.codejava.net/", "downloadResponse");
    private final static QName _UploadResponse_QNAME = new QName("http://server.binary.ws.codejava.net/", "uploadResponse");
    private final static QName _Upload_QNAME = new QName("http://server.binary.ws.codejava.net/", "upload");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.binary.ws.codejava.net/", name = "download")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.binary.ws.codejava.net/", name = "downloadResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.binary.ws.codejava.net/", name = "uploadResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.binary.ws.codejava.net/", name = "upload")
