 ...
 * 
 */
@WebServiceClient(name = "FileTransfererImplService", targetNamespace = "http://server.binary.ws.codejava.net/", wsdlLocation = "http://localhost:9898/codejava/fileService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName FILETRANSFERERIMPLSERVICE_QNAME = new QName("http://server.binary.ws.codejava.net/", "FileTransfererImplService");
    ...
    public FileTransfererImpl getFileTransfererImplPort() {
        return super.getPort(new QName("http://server.binary.ws.codejava.net/", "FileTransfererImplPort"), FileTransfererImpl.class);
    }
    ...
    public FileTransfererImpl getFileTransfererImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.binary.ws.codejava.net/", "FileTransfererImplPort"), FileTransfererImpl.class, features);
    }
